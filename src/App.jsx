...
function App() {
  ...
  return (
    <div className="bg-slate-950 overflow-x-hidden">
      ...
      {/* --- ABOUT SECTION --- */}
      <section id="about" className="min-h-[100dvh] w-full flex flex-col bg-slate-800/20 px-6 py-20 justify-center overflow-hidden">
        <div ref={aboutAnim.elementRef} className={`max-w-6xl mx-auto w-full ${aboutAnim.animationClass} flex flex-col mt-0 lg:-mt-16`}>
